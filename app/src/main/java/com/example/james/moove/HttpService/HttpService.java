...
public class HttpService {
    ...
    public  String getTV(String tv) throws IOException {
        OkHttpClient client=new OkHttpClient.Builder()
                .build();
        HttpUrl.Builder builder=HttpUrl.parse(Constants.TV_SEARCH_BASE_URL).newBuilder();
        builder.addQueryParameter(Constants.API_KEY_QUERY,Constants.API_KEY);
        builder.addQueryParameter(Constants.MOVIE_QUERY,tv);
    ...
    public String getTVTypes(String type) throws IOException{
        OkHttpClient client=new OkHttpClient.Builder()
                .build();
        HttpUrl.Builder builder=HttpUrl.parse(Constants.TV_BASE_URL+type).newBuilder();
        builder.addQueryParameter(Constants.API_KEY_QUERY,Constants.API_KEY);
